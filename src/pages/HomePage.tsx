...
const HomePage = () => (
  <div>
    ...
    <section className="container mx-auto px-4 py-16">
      ...
      <p className="text-muted-foreground mb-8 max-w-4xl">Everything you need to get started — handpicked courses, reviewed tools, and trusted networks in one place.</p>
    ...
    <section className="container mx-auto px-4 py-16">
      ...
      <p className="text-muted-foreground mb-8 max-w-4xl">A growing library of reviews, courses and insights — built from over a decade of hands-on work.</p>
    ...
    <section className="container mx-auto px-4 py-16">
      ...
      <p className="text-muted-foreground mb-8 max-w-4xl">Fresh guides, strategies and tips to help you build and grow your affiliate business.</p>
