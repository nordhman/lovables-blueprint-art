...
const CoursesPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <h1 className="text-3xl md:text-4xl font-bold mt-2">Courses</h1>
      <p className="text-muted-foreground mt-2 max-w-2xl">Curated courses for affiliate marketing – our own courses and handpicked recommendations from the best in the industry.</p>
